-- Made by nikola1h2w (Pirate Hub key: https://pastebin.com/vCwfFmP0)
...
local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
    ...
    Library:SetWatermark(('Pirate Hub | %s fps | %s ms'):format(
        math.floor(FPS),
...
CreditsGroup:AddLabel('Made by nikola1h2w!')
CreditsGroup:AddLabel('Made with love and hate :3')

local DiscordButton = CreditsGroup:AddButton({
    Text = 'Copy Pirate Hub Discord Link',
    Func = function()
        setclipboard('https://discord.com/channels/1340713097203286178/1340713718710931620')
    end,
    DoubleClick = false,
    Tooltip = 'Join Pirate Hub discord server!'
})


CreditsGroup:AddLabel("Tanks for using")
